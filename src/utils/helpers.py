...
#         self.neptune_logger.log_metrics({'epoch': trainer.current_epoch,
#                                          'train_loss': trainer.callback_metrics['train_loss'].item(),
#                                          'val_loss': trainer.callback_metrics['val_loss'].item()})
#
#     def on_validation_epoch_end(self, trainer, pl_module):
#         # Log additional validation metrics to Neptune
#         val_accuracy = trainer.callback_metrics['val_accuracy'].item()
#         self.neptune_logger.log_metrics({'val_accuracy': val_accuracy})
