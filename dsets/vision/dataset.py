...
from dsets.utils import register_dataset
...
################################# Added for DL #########################################
@register_dataset(dataset='c10-HLS')
class CIFAR10HLSDataset(VisionDataset):
    mean = (0.4416, 0.464, 0.6101)
    std = (0.0966, 0.1084, 0.2084)
    num_classes = 10
    image_size = 32
...
@register_dataset(dataset='c10-HSV')
class CIFAR10HSVDataset(VisionDataset):
    mean = (0.4415, 0.6871, 0.7149)
    std = (0.0967, 0.1498, 0.1807)
    num_classes = 10
    image_size = 32
...
@register_dataset(dataset='c10-LUV')
class CIFAR10LUVDataset(VisionDataset):
    mean = (0.4053, 0.3551, 0.267)
    std = (0.094, 0.0523, 0.1664)
    num_classes = 10
    image_size = 32
...
@register_dataset(dataset='c10-YUV')
class CIFAR10YUVDataset(VisionDataset):
    mean = (0.3516, 0.6689, 0.4283)
    std = (0.0873, 0.1038, 0.1112)
    num_classes = 10
    image_size = 32
...
################################# Added for DL #########################################
@register_dataset(dataset='c10-HLS', is_c=True)
class CIFAR10CHLSDataset(VisionDataset):
    mean = CIFAR10HLSDataset.mean
    std = CIFAR10HLSDataset.std
    num_classes = CIFAR10HLSDataset.num_classes
    image_size = CIFAR10HLSDataset.image_size
...
@register_dataset(dataset='c10-HSV', is_c=True)
class CIFAR10CHSVDataset(VisionDataset):
    mean = CIFAR10HSVDataset.mean
    std = CIFAR10HSVDataset.std
    num_classes = CIFAR10HSVDataset.num_classes
    image_size = CIFAR10HSVDataset.image_size
...
@register_dataset(dataset='c10-LUV', is_c=True)
class CIFAR10CLUVDataset(VisionDataset):
    mean = CIFAR10LUVDataset.mean
    std = CIFAR10LUVDataset.std
    num_classes = CIFAR10LUVDataset.num_classes
    image_size = CIFAR10LUVDataset.image_size
...
@register_dataset(dataset='c10-YUV', is_c=True)
class CIFAR10CYUVDataset(VisionDataset):
    mean = CIFAR10YUVDataset.mean
    std = CIFAR10YUVDataset.std
    num_classes = CIFAR10YUVDataset.num_classes
    image_size = CIFAR10YUVDataset.image_size
